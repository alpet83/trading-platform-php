-- Clean template: Deribit BTC/ETH only
-- Note: trading.deribit__pairs_map is absent in current trading schema.
-- Pair_id values 1/3 are kept for compatibility with existing routing.
...
INSERT INTO `ticker_map` (`id`, `ticker`, `symbol`, `pair_id`) VALUES
    (1, 'btcusd', 'BTC-USD-PERPETUAL', 1),
    (3, 'ethusd', 'ETH-USD-PERPETUAL', 3);
