-- Clean template: Binance BTC/ETH only
-- Source of truth: trading.binance__pairs_map (pair_id 1,3)
...
-- Hard reset to avoid keeping old tickers.
...
-- Candles only: no depth, no ticks.
