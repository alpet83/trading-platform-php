-- Clean template: Bybit BTC/ETH only
-- Source of truth: trading.bybit__pairs_map (pair_id 1,3)
-- Important: ticker is universal across exchanges, symbol is exchange-specific.
