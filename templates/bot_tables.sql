...
--
-- NOTE: Order tables were moved to templates/bot_orders_table.sql
-- and are created in a dedicated loop by bot_creator / EnsureBotTables.
-- This file now contains only non-order bot tables.
...
CREATE TABLE IF NOT EXISTS `#exchange__position_history` (
    ...
    avg_pos_price DOUBLE DEFAULT 0 NOT NULL,
    target     FLOAT NULL,
