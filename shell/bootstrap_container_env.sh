...
GRANT ALL PRIVILEGES ON \`datafeed\`.* TO '$TRADING_DB_USER'@'%';
GRANT ALL PRIVILEGES ON \`binance\`.* TO '$TRADING_DB_USER'@'%';
GRANT ALL PRIVILEGES ON \`bitmex\`.* TO '$TRADING_DB_USER'@'%';
GRANT ALL PRIVILEGES ON \`bitfinex\`.* TO '$TRADING_DB_USER'@'%';
GRANT ALL PRIVILEGES ON \`bybit\`.* TO '$TRADING_DB_USER'@'%';
GRANT ALL PRIVILEGES ON \`deribit\`.* TO '$TRADING_DB_USER'@'%';
FLUSH PRIVILEGES;
EOF
